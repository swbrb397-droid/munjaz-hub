...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام وسياسة إخلاء المسؤولية | مُنجَز" },
      { name: "description", content: "الشروط والأحكام وسياسة إخلاء المسؤولية لمنصة مُنجَز — منصة الخدمات الرقمية ووسيط الضمان بعملة USDT." },
      { property: "og:title", content: "الشروط والأحكام وسياسة إخلاء المسؤولية | مُنجَز" },
      { property: "og:description", content: "اقرأ الشروط الكاملة التي تحكم استخدام منصة مُنجَز، والتعاملات المالية بـ USDT، ونظام الضمان، والنزاعات، والملكية الفكرية." },
...
function TermsPage() {
  ...
  return (
    <Section
      ...
      subtitle={tr(
        "يُرجى قراءة هذه الشروط بعناية قبل استخدام منصة مُنجَز. استخدامك للمنصة يعني موافقتك الكاملة والمسبقة على جميع البنود أدناه.",
        "Please read these terms carefully before using Munjaz. By accessing or using the platform, you agree to be bound by all provisions below.",
      )}
    >
      ...
      <div className="grid gap-6">
        <Clause
          ...
          body={tr(
            `تعمل منصة مُنجَز كوسيط تقني إلكتروني فحسب، تربط بين البائعين (مُقدّمي الخدمات والمنتجات الرقمية) والمشترين. لا تُعدّ مُنجَز طرفاً في أي عقد مباشر، ولا توظّف المستقلين أو المُدرّبين أو مُنشئي المحتوى، ولا تضمن جودة أي عمل أو خدمة أو منتج رقمي أو NFT. كل المحتوى والعروض والتقييمات منشأة من المستخدمين، ولا تُمثّل توصية أو اعتماداً من منصة مُنجَز. المنصة غير مسؤولة عن أي خلاف ينشأ بين المستخدمين، باستثناء تطبيق آليات الضمان والنزاعات المُعلنة في هذه الشروط.`,
            `Munjaz operates solely as a technical electronic intermediary connecting sellers (service providers, digital product creators, and NFT sellers) with buyers. Munjaz is not a party to any direct contract, does not employ freelancers, trainers, or content creators, and does not guarantee the quality of any work, service, digital product, or NFT. All content, listings, and reviews are user-generated and do not constitute an endorsement or recommendation by Munjaz. The platform is not liable for disputes arising between users, except as provided through the escrow and dispute mechanisms described herein.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `المستخدم وحده مسؤول عن إدخال عناوين محافظ USDT الصحيحة واختيار الشبكة المتوافقة (TRC-20 أو BEP-20 أو Polygon). لا تتحمّل مُنجَز أي مسؤولية عن فقدان الأموال نتيجة اختيار شبكة خاطئ، أو خطأ في العنوان، أو انقطاع خدمة المحفظة الخارجية. مُنجَز ليست بنكاً أو مؤسسة مالية، ولا تضمن سرعة تأكيدات الشبكات الخارجية أو تقلّبات رسوم الغاز (gas fees) أو تغيّر الأنظمة التنظيمية للعملات الرقمية في اختصاص المستخدم. لا يتم تقديم أي مشورة مالية أو استثمارية عبر المنصة.`,
            `The user is solely responsible for entering correct USDT wallet addresses and selecting the compatible network (TRC-20, BEP-20, or Polygon). Munjaz is not liable for any loss of funds resulting from incorrect network selection, wrong addresses, or failure of an external wallet service. Munjaz is not a bank or financial institution, does not guarantee confirmation speeds on external networks, gas fee fluctuations, or regulatory changes regarding cryptocurrencies in the user's jurisdiction. No financial or investment advice is provided through the platform.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `يُحظر تماماً على جميع المستخدمين إجراء تواصل أو دفع خارج منصة مُنجَز بهدف تجاوز رسوم المنصة أو نظام الضمان. يشمل الحظر مشاركة أرقام هواتف، عناوين بريد إلكتروني، حسابات وسائل التواصل، أو روابط محافظ خارجية داخل مساحة الطلب أو المراسلة. أي محاولة للتعامل الخارجي تُعدّ خرقاً جوهرياً، ويترتب عليه: تعليق الحساب نهائياً، ومصادرة أي عمولات إحالة معلّقة، وسحب شارة التوثيق، وإلغاء جميع الحمايات والضمانات. تحتفظ المنصة بحق متابعة المستخدم مخالفاً للتعويضات القانونية.`,
            `All users are strictly prohibited from communicating or making payments outside the Munjaz platform to bypass platform fees or escrow. This includes sharing phone numbers, email addresses, social media accounts, or external wallet links inside order workspaces or chat. Any off-platform attempt is a material breach, resulting in: permanent account suspension, forfeiture of all pending affiliate commissions, revocation of verified badge status, and loss of all protections and escrow guarantees. The platform reserves the right to pursue legal remedies against violating users.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `يُقرّ البائع بأنه يملك 100% من الحقوق القانونية للأصول والمحتويات والمنتجات والـ NFT المعروضة، أو أنه حاصل على ترخيص صريح لبيعها أو استخدامها تجارياً. مُنجَز لا تتحقّق من صحة الملكية الفكرية لكل عرض بشكل فردي، ولا تتحمل أي مسؤولية عن انتهاك حقوق الطبع أو العلامة التجارية أو سرّية تجارية من قبل البائع. في حال تلقّي إشعار تعدٍ صحيح (DMCA)، سيتم إزالة العرض المعنيّ فوراً وقد يُعلق حساب البائع. المشتري يتحمل مخاطر شراء الأصول الرقمية، ولا يجوز إعادة بيعها أو توزيعها إذا نصّت الرخصة على ذلك.`,
            `The seller represents that they own 100% of the legal rights to the assets, content, products, and NFTs listed, or have explicit licensing to sell or use them commercially. Munjaz does not individually verify the intellectual property rights of every listing and assumes no liability for seller copyright, trademark, or trade-secret infringement. Upon receipt of a valid takedown notice (DMCA), the affected listing will be removed immediately and the seller's account may be suspended. The buyer assumes the risk of purchasing digital assets and may not resell or redistribute them if the license prohibits it.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `إلى الحد الأقصى المسموح به بموجب القانون، لا تكون مُنجَز أو مؤسسوها أو مشغّلوها أو شركاؤها أو مزوّدو خدماتها مسؤولين عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية أو خسارة أرباح أو فساد بيانات أو انقطاع أعمال، ينشأ عن استخدام المنصة أو عدم القدرة على استخدامها، أو عن انقطاع خدمات الطرف الثالث (مثل Supabase أو Gemini أو WebRTC أو مزوّدي البلوكتشين). يوافق المستخدم على تعويض مُنجَز والدفاع عنها ضد أي مطالبات أو خسائر أو تكاليف تنشأ عن استخدامه للمنصة أو خرقه لهذه الشروط. لا تتجاوز مسؤولية مُنجَز المباشرة — إذا ثبتت — قيمة الرسوم المدفوعة للمنصة في المعاملة التي تسببت في الضرر.`,
            `To the maximum extent permitted by law, Munjaz, its founders, operators, partners, and service providers shall not be liable for any direct, indirect, incidental, consequential, or special damages, lost profits, data corruption, or business interruption arising from use of or inability to use the platform, or from third-party service outages (such as Supabase, Gemini, WebRTC, or blockchain providers). The user agrees to indemnify, defend, and hold Munjaz harmless against any claims, losses, or costs arising from their use of the platform or breach of these terms. Munjaz's direct liability—if proven—shall not exceed the platform fees paid for the specific transaction giving rise to the damage.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `للاستفسارات القانونية أو إرسال إشعارات التعدي (DMCA) أو الشكاوى التنظيمية، يُرجى التواصل مع فريق مُنجَز عبر القنوات الرسمية المُعلنة في صفحة "اتصل بنا" أو التذاكر الداخلية. لا يُعتبر التواصل عبر وسائل غير رسمية إشعاراً قانونياً صحيحاً.`,
            `For legal inquiries, DMCA takedown notices, or regulatory complaints, please contact the Munjaz team through the official channels listed on the Contact page or internal support tickets. Communications through unofficial channels are not considered valid legal notices.`,
          )}
        />
      </div>
      ...
      <Card className="mt-8 border-primary/20 bg-primary/5">
        <p className="text-sm leading-relaxed text-foreground">
          {tr(
            "باستخدامك لمنصة مُنجَز، فإنك تؤكد أنك قرأت هذه الشروط وفهمتها ووافقت عليها. إذا لم توافق على أي جزء منها، يجب أن تتوقف عن استخدام المنصة فوراً.",
            "By using Munjaz, you confirm that you have read, understood, and agree to these terms. If you do not agree with any part of them, you must stop using the platform immediately.",
          )}
        </p>
      </Card>
    </Section>
