...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام وسياسة إخلاء المسؤولية | المُنجِز" },
      { name: "description", content: "الشروط والأحكام وسياسة إخلاء المسؤولية لمنصة المُنجِز — منصة الخدمات الرقمية ووسيط الضمان بعملة USDT." },
      { property: "og:title", content: "الشروط والأحكام وسياسة إخلاء المسؤولية | المُنجِز" },
      { property: "og:description", content: "اقرأ الشروط الكاملة التي تحكم استخدام منصة المُنجِز، والتعاملات المالية بـ USDT، ونظام الضمان، والنزاعات، والملكية الفكرية." },
...
function TermsPage() {
  ...
  return (
    <Section
      ...
      subtitle={tr(
        "يُرجى قراءة هذه الشروط بعناية قبل استخدام منصة المُنجِز. استخدامك للمنصة يعني موافقتك الكاملة والمسبقة على جميع البنود أدناه.",
    ...
    >
      ...
      <div className="grid gap-6">
        <Clause
          ...
          body={tr(
            `تعمل منصة المُنجِز كوسيط تقني إلكتروني فحسب، تربط بين البائعين (مُقدّمي الخدمات والمنتجات الرقمية) والمشترين. لا تُعدّ المُنجِز طرفاً في أي عقد مباشر، ولا توظّف المستقلين أو المُدرّبين أو مُنشئي المحتوى، ولا تضمن جودة أي عمل أو خدمة أو منتج رقمي أو NFT. كل المحتوى والعروض والتقييمات منشأة من المستخدمين، ولا تُمثّل توصية أو اعتماداً من منصة المُنجِز. المنصة غير مسؤولة عن أي خلاف ينشأ بين المستخدمين، باستثناء تطبيق آليات الضمان والنزاعات المُعلنة في هذه الشروط.`,
        ...
        <Clause
          ...
          body={tr(
            `المستخدم وحده مسؤول عن إدخال عناوين محافظ USDT الصحيحة واختيار الشبكة المتوافقة (TRC-20 أو BEP-20 أو Polygon). لا تتحمّل المُنجِز أي مسؤولية عن فقدان الأموال نتيجة اختيار شبكة خاطئ، أو خطأ في العنوان، أو انقطاع خدمة المحفظة الخارجية. المُنجِز ليست بنكاً أو مؤسسة مالية، ولا تضمن سرعة تأكيدات الشبكات الخارجية أو تقلّبات رسوم الغاز (gas fees) أو تغيّر الأنظمة التنظيمية للعملات الرقمية في اختصاص المستخدم. لا يتم تقديم أي مشورة مالية أو استثمارية عبر المنصة.`,
        ...
        <Clause
          ...
          title={tr("3. نظام الضمان والتحكيم الآلي وحق التصعيد البشري", "3. Escrow, AI Arbitration & Human Escalation Right")}
          body={tr(
            `عند إنشاء طلب، يتم تجميد رصيد المشتري في حساب الضمان الداخلي حتى يتم اعتماد التسليم أو حل النزاع. مدة حجز الضمان بعد التسليم: 48 ساعة للباقة المجانية، 24 ساعة لباقة Pro (مع توثيق KYC)، و16–24 ساعة لباقة الشركات، وبعدها تُحرَّر الأموال تلقائياً إن لم يوجد اعتراض. في النزاعات، يحلّل وكيل الذكاء الاصطناعي الأدلة والمراسلات والبنود المتفق عليها ويُصدر قراراً ابتدائياً. يحق لأي طرف تصعيد القرار الابتدائي إلى التحكيم البشري لدى إدارة المنصة خلال 24 ساعة من صدوره، ويكون قرار التحكيم البشري نهائياً ومُلزماً. تُطبَّق القرارات فور انقضاء مهلة التصعيد. كما يُعدّ تحرير أي مرحلة (Milestone) إجراءً نهائياً غير قابل للنقض أو النزاع بعد تنفيذه.`,
            `When an order is created, the buyer's funds are locked in internal escrow until delivery is approved or the dispute is resolved. Post-delivery escrow hold: 48 hours on Free, 24 hours on Pro (with KYC), and 16-24 hours on Corporate, after which funds auto-release absent an objection. In disputes, the AI agent analyses evidence, communications and agreed terms and issues an initial determination. Either party may escalate that initial determination to human arbitration by platform administration within 24 hours; the human arbitration decision is final and binding. Decisions apply once the escalation window lapses. Releasing a milestone is irrevocable and cannot be disputed afterwards.`,
          )}
        />
        ...
        <Clause
          ...
          body={tr(
            `يُحظر تماماً على جميع المستخدمين إجراء تواصل أو دفع خارج منصة المُنجِز بهدف تجاوز رسوم المنصة أو نظام الضمان. يشمل الحظر مشاركة أرقام هواتف، عناوين بريد إلكتروني، حسابات وسائل التواصل، أو روابط محافظ خارجية داخل مساحة الطلب أو المراسلة. أي محاولة للتعامل الخارجي تُعدّ خرقاً جوهرياً، ويترتب عليه: تعليق الحساب نهائياً، ومصادرة أي عمولات إحالة معلّقة، وسحب شارة التوثيق، وإلغاء جميع الحمايات والضمانات. تحتفظ المنصة بحق متابعة المستخدم مخالفاً للتعويضات القانونية.`,
        ...
        <Clause
          ...
          body={tr(
            `يُقرّ البائع بأنه يملك 100% من الحقوق القانونية للأصول والمحتويات والمنتجات والـ NFT المعروضة، أو أنه حاصل على ترخيص صريح لبيعها أو استخدامها تجارياً. المُنجِز لا تتحقّق من صحة الملكية الفكرية لكل عرض بشكل فردي، ولا تتحمل أي مسؤولية عن انتهاك حقوق الطبع أو العلامة التجارية أو سرّية تجارية من قبل البائع. في حال تلقّي إشعار تعدٍ صحيح (DMCA)، سيتم إزالة العرض المعنيّ فوراً وقد يُعلق حساب البائع. المشتري يتحمل مخاطر شراء الأصول الرقمية، ولا يجوز إعادة بيعها أو توزيعها إذا نصّت الرخصة على ذلك.`,
        ...
        <Clause
          ...
          body={tr(
            `إلى الحد الأقصى المسموح به بموجب القانون، لا تكون المُنجِز أو مؤسسوها أو مشغّلوها أو شركاؤها أو مزوّدو خدماتها مسؤولين عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية أو خسارة أرباح أو فساد بيانات أو انقطاع أعمال، ينشأ عن استخدام المنصة أو عدم القدرة على استخدامها، أو عن انقطاع خدمات الطرف الثالث (مثل Supabase أو Gemini أو WebRTC أو مزوّدي البلوكتشين). يوافق المستخدم على تعويض المُنجِز والدفاع عنها ضد أي مطالبات أو خسائر أو تكاليف تنشأ عن استخدامه للمنصة أو خرقه لهذه الشروط. لا تتجاوز مسؤولية المُنجِز المباشرة — إذا ثبتت — قيمة الرسوم المدفوعة للمنصة في المعاملة التي تسببت في الضرر.`,
        ...
        <Clause
          ...
          body={tr(
            `للاستفسارات القانونية أو إرسال إشعارات التعدي (DMCA) أو الشكاوى التنظيمية، يُرجى التواصل مع فريق المُنجِز عبر القنوات الرسمية المُعلنة في صفحة "اتصل بنا" أو التذاكر الداخلية. لا يُعتبر التواصل عبر وسائل غير رسمية إشعاراً قانونياً صحيحاً.`,
      ...
      <Card className="mt-8 border-primary/20 bg-primary/5">
        <p className="text-sm leading-relaxed text-foreground">
          {tr(
            "باستخدامك لمنصة المُنجِز، فإنك تؤكد أنك قرأت هذه الشروط وفهمتها ووافقت عليها. إذا لم توافق على أي جزء منها، يجب أن تتوقف عن استخدام المنصة فوراً.",
