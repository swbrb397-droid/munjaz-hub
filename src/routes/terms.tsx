...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام وسياسة إخلاء المسؤولية | الـمُـنْـجِـز" },
      { name: "description", content: "الشروط والأحكام وسياسة إخلاء المسؤولية لمنصة الـمُـنْـجِـز — منصة الخدمات الرقمية ووسيط الضمان بعملة USDT." },
      { property: "og:title", content: "الشروط والأحكام وسياسة إخلاء المسؤولية | الـمُـنْـجِـز" },
      { property: "og:description", content: "اقرأ الشروط الكاملة التي تحكم استخدام منصة الـمُـنْـجِـز، والتعاملات المالية بـ USDT، ونظام الضمان، والنزاعات، والملكية الفكرية." },
...
function TermsPage() {
  ...
  return (
    <Section
      ...
      subtitle={tr(
        "يُرجى قراءة هذه الشروط بعناية قبل استخدام منصة الـمُـنْـجِـز. استخدامك للمنصة يعني موافقتك الكاملة والمسبقة على جميع البنود أدناه.",
    ...
    >
      ...
      <div className="grid gap-6">
        <Clause
          ...
          body={tr(
            `تعمل منصة الـمُـنْـجِـز كوسيط تقني إلكتروني فحسب، تربط بين البائعين (مُقدّمي الخدمات والمنتجات الرقمية) والمشترين. لا تُعدّ الـمُـنْـجِـز طرفاً في أي عقد مباشر، ولا توظّف المستقلين أو المُدرّبين أو مُنشئي المحتوى، ولا تضمن جودة أي عمل أو خدمة أو منتج رقمي أو NFT. كل المحتوى والعروض والتقييمات منشأة من المستخدمين، ولا تُمثّل توصية أو اعتماداً من منصة الـمُـنْـجِـز. المنصة غير مسؤولة عن أي خلاف ينشأ بين المستخدمين، باستثناء تطبيق آليات الضمان والنزاعات المُعلنة في هذه الشروط.`,
        ...
        <Clause
          ...
          body={tr(
            `المستخدم وحده مسؤول عن إدخال عناوين محافظ USDT الصحيحة واختيار الشبكة المتوافقة (TRC-20 أو BEP-20 أو Polygon). لا تتحمّل الـمُـنْـجِـز أي مسؤولية عن فقدان الأموال نتيجة اختيار شبكة خاطئ، أو خطأ في العنوان، أو انقطاع خدمة المحفظة الخارجية. الـمُـنْـجِـز ليست بنكاً أو مؤسسة مالية، ولا تضمن سرعة تأكيدات الشبكات الخارجية أو تقلّبات رسوم الغاز (gas fees) أو تغيّر الأنظمة التنظيمية للعملات الرقمية في اختصاص المستخدم. لا يتم تقديم أي مشورة مالية أو استثمارية عبر المنصة.`,
        ...
        <Clause
          ...
          body={tr(
            `يُحظر تماماً على جميع المستخدمين إجراء تواصل أو دفع خارج منصة الـمُـنْـجِـز بهدف تجاوز رسوم المنصة أو نظام الضمان. يشمل الحظر مشاركة أرقام هواتف، عناوين بريد إلكتروني، حسابات وسائل التواصل، أو روابط محافظ خارجية داخل مساحة الطلب أو المراسلة. أي محاولة للتعامل الخارجي تُعدّ خرقاً جوهرياً، ويترتب عليه: تعليق الحساب نهائياً، ومصادرة أي عمولات إحالة معلّقة، وسحب شارة التوثيق، وإلغاء جميع الحمايات والضمانات. تحتفظ المنصة بحق متابعة المستخدم مخالفاً للتعويضات القانونية.`,
        ...
        <Clause
          ...
          body={tr(
            `يُقرّ البائع بأنه يملك 100% من الحقوق القانونية للأصول والمحتويات والمنتجات والـ NFT المعروضة، أو أنه حاصل على ترخيص صريح لبيعها أو استخدامها تجارياً. الـمُـنْـجِـز لا تتحقّق من صحة الملكية الفكرية لكل عرض بشكل فردي، ولا تتحمل أي مسؤولية عن انتهاك حقوق الطبع أو العلامة التجارية أو سرّية تجارية من قبل البائع. في حال تلقّي إشعار تعدٍ صحيح (DMCA)، سيتم إزالة العرض المعنيّ فوراً وقد يُعلق حساب البائع. المشتري يتحمل مخاطر شراء الأصول الرقمية، ولا يجوز إعادة بيعها أو توزيعها إذا نصّت الرخصة على ذلك.`,
        ...
        <Clause
          ...
          body={tr(
            `إلى الحد الأقصى المسموح به بموجب القانون، لا تكون الـمُـنْـجِـز أو مؤسسوها أو مشغّلوها أو شركاؤها أو مزوّدو خدماتها مسؤولين عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية أو خسارة أرباح أو فساد بيانات أو انقطاع أعمال، ينشأ عن استخدام المنصة أو عدم القدرة على استخدامها، أو عن انقطاع خدمات الطرف الثالث (مثل Supabase أو Gemini أو WebRTC أو مزوّدي البلوكتشين). يوافق المستخدم على تعويض الـمُـنْـجِـز والدفاع عنها ضد أي مطالبات أو خسائر أو تكاليف تنشأ عن استخدامه للمنصة أو خرقه لهذه الشروط. لا تتجاوز مسؤولية الـمُـنْـجِـز المباشرة — إذا ثبتت — قيمة الرسوم المدفوعة للمنصة في المعاملة التي تسببت في الضرر.`,
        ...
        <Clause
          ...
          body={tr(
            `للاستفسارات القانونية أو إرسال إشعارات التعدي (DMCA) أو الشكاوى التنظيمية، يُرجى التواصل مع فريق الـمُـنْـجِـز عبر القنوات الرسمية المُعلنة في صفحة "اتصل بنا" أو التذاكر الداخلية. لا يُعتبر التواصل عبر وسائل غير رسمية إشعاراً قانونياً صحيحاً.`,
      ...
      <Card className="mt-8 border-primary/20 bg-primary/5">
        <p className="text-sm leading-relaxed text-foreground">
          {tr(
            "باستخدامك لمنصة الـمُـنْـجِـز، فإنك تؤكد أنك قرأت هذه الشروط وفهمتها ووافقت عليها. إذا لم توافق على أي جزء منها، يجب أن تتوقف عن استخدام المنصة فوراً.",
