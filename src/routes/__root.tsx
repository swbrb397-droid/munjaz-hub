  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        {error?.message ? (
          <pre className="mt-4 max-h-40 overflow-auto whitespace-pre-wrap rounded-lg border border-border bg-muted/40 p-3 text-right text-[11px] leading-relaxed text-muted-foreground">
            {error.message}
          </pre>
        ) : null}
