...
export const Route = createFileRoute("/_authenticated/create-listing")({
  head: () => ({
    meta: [
      { title: "إنشاء عرض جديد | المنجز" },
      { name: "description", content: "أنشئ عدداً غير محدود من الخدمات والمنتجات الرقمية على المنجز بحد أدنى 3 USDT للعرض الواحد." },
      { property: "og:title", content: "إنشاء عرض جديد | المنجز" },
