...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      { title: "التحقق من المستندات | المنجز" },
      { name: "description", content: "تحقّق من أصالة إيصالات وسجلات المنجز عبر بصمة التحقق المطبوعة على ملف PDF." },
      { property: "og:title", content: "التحقق من المستندات | المنجز" },
          ...
          {result.doc ? (
            <div className="relative grid gap-4">
              ...
              <p className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                ...
                {tr("موقّع رقمياً بختم منصة المنجز للضمان.", "Digitally signed with the Al-Munjaz escrow platform seal.")}
              </p>
            </div>
          ) : (
